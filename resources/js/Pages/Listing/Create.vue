    ...
    <form @submit.prevent="create">
      <div>
        <div>
          ...
          <div class="" v-if="form.errors.beds">
        ...
        <div>
          ...
          <div class="" v-if="form.errors.baths">
        ...
        <div>
          ...
          <div class="" v-if="form.errors.area">
        ...
        <div>
          ...
          <div class="" v-if="form.errors.city">
        ...
        <div>
          ...
          <div class="" v-if="form.errors.code">
        ...
        <div>
          ...
          <div class="" v-if="form.errors.street">
        ...
        <div>
          ...
          <div class="" v-if="form.errors.street_nr">
        ...
        <div>
          ...
          <div class="" v-if="form.errors.price">
