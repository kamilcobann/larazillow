<template>
    ...
    class="border-b border-gray-200 dark:border-gray-800 py-4 flex justify-between items-center">
        ...
        <div class="">
            ...
            method="put" 
            v-if="!notification.read_at" class="button-outline text-xs font-medium uppercase">
                Mark as read
            </Link>
        </div>
    ...
    <section v-if="notifications.data.length" class="w-full flex justify-center my-4">
