...
Route::prefix('realtor')->name('realtor.')->middleware(['auth','verified'])->group(
    function (){
        ...
        Route::name('offer.accept')->put('offer/{offer}/accept',[RealtorListingAcceptOfferController::class,'__invoke']);
